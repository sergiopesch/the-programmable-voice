...
export const soundArtefacts: SoundArtefact[] = [
  ...
  { kind: 'file', year: '1992–1995', title: '.mp3 file', detail: 'MPEG-1 Layer III standardised perceptual compression in 1992; the .mp3 filename suffix followed in 1995.', preserves: 'Copyable, searchable sound at a useful size', discards: 'Codec-dependent detail and, unless carried separately, historical context', citations: ['med-loc-mp3', 'med-fraunhofer-mp3'] },
  { kind: 'token', year: '2021', title: 'Audio token', detail: 'A learned codec maps recurring acoustic patterns to codebook indices that another model can process.', preserves: 'Features useful to the training and reconstruction objective', discards: 'Detail the objective and bitrate did not reward is not preserved reliably; unintended identity, channel or private cues may nevertheless remain', citations: ['mac-soundstream2021', 'mac-encodec2022'] },
]
